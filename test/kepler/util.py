...
# ALPM
PM_ROOT     = "/"
PM_DBPATH   = "var/lib/kepler"
PM_SYNCDBPATH = "var/lib/kepler/sync"
PM_LOCK     = "var/lib/kepler/db.lck"
PM_CACHEDIR = "var/cache/kepler/pkg"
PM_EXT_PKG  = ".pkg.tar.gz"
PM_HOOKDIR  = "etc/kepler.d/hooks"

# Kepler
PACCONF     = "etc/kepler.conf"
