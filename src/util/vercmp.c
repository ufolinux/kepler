/*
 *  vercmp.c - Compare package version numbers using kepler's version
 *      comparison logic
 *
...
{
	fprintf(stderr, "vercmp (kepler) v" PACKAGE_VERSION "\n\n"
		"Compare package version numbers using kepler's version comparison logic.\n\n"
