...
Introduction
------------
kepler is a utility which manages software packages in Linux. It uses simple
...
kepler does not strive to "do everything." It will add, remove and upgrade
...
History
~~~~~~~
Version 2.0 of kepler introduced the ability to sync packages (the '\--sync'
...
Version 3.0 was the switch to a two-part kepler -- a back-end named libalpm
(library for Arch Linux Package Management) and the familiar kepler front-end.
...
makepkg/repo-add/kepler toolchain via GnuPG and GPGME.
...
configuration files dealing with kepler.
...
* linkman:kepler[8]
* linkman:kepler-key[8]
* linkman:kepler-conf[8]
...
Changelog
~~~~~~~~~
For a good idea of what is going on in kepler development, take a look at the
link:https://gitlab.archlinux.org/kepler/kepler[Git summary page] for the
project.

See the most recent
link:https://gitlab.archlinux.org/kepler/kepler/-/blob/master/NEWS[NEWS]
...
link:https://sources.archlinux.org/other/kepler/[]. To install, download the newest
...
Mailing List
~~~~~~~~~~~~
There is a mailing list devoted to kepler development, hosted by Arch Linux.
link:https://lists.archlinux.org/listinfo/kepler-dev/[Subscribe] or
link:https://lists.archlinux.org/pipermail/kepler-dev/[view the archives].

Source Code
~~~~~~~~~~~
Development of kepler is currently done in Git. The central repository is
...
which will fetch the full development history into a directory named kepler.
You can browse the source as well using
link:https://gitlab.archlinux.org/kepler/kepler/[gitlab].

If you are interested in hacking on kepler, it is highly recommended you join
...
Bugs
----
If you find bugs (which is quite likely), please email them to the kepler-dev
mailing last at mailto:kepler-dev@lists.archlinux.org[] with specific information
...
bugs under the Kepler project.

Copyright
---------
kepler is Copyright (C) 2006-2022 Kepler Development Team
<kepler-dev@lists.archlinux.org> and Copyright (C) 2002-2006 Judd Vinet
