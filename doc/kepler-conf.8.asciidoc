...
Name
----
kepler-conf - query kepler's configuration file


Synopsis
--------
'kepler-conf' [options] [<directive> ...]

'kepler-conf' (--repo-list|--help|--version)


Description
-----------
'kepler-conf' is a utility for parsing the 'kepler' configuration file
...
same configuration values which 'kepler' itself would use.

'kepler-conf' will output the fully-resolved contents of the
